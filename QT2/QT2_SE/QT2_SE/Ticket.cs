...
namespace QT2_SE
{
    public partial class Ticket : Form
    {
        ...
        {
            cmb_Destination.Items.AddRange(new string[] { "Bến Thành Market", "Tân Sơn Nhất Airport", "Nguyễn Huệ Walking Street", "Công Viên Tao Đàn", "Dinh Độc Lập","Ga Sài Gòn"
 });
        }
        private void LoadTransportModes()
        {
            cmb_Transport.Items.AddRange(new string[] { "Bus: 5$ ", "Metro: 20$ ", "Train: 10$ " });
        }
        ...
        private void cmb_Transport_SelectedIndexChanged(object sender, EventArgs e)
        {
